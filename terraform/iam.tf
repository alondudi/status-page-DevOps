resource "aws_iam_role" "eks_cluster_role" {
  name = "status-page-eks-cluster-role-aa"
...
resource "aws_iam_role" "eks_node_role" {
  name = "status-page-eks-node-role-aa"
...
resource "aws_iam_policy" "alb_controller" {
  name        = "AWSLoadBalancerControllerIAMPolicy-AA"
...
resource "aws_iam_role" "alb_controller" {
  name = "status-page-alb-controller-role"
...
resource "aws_iam_role" "external_dns" {
  name = "status-page-external-dns-role-aa"
